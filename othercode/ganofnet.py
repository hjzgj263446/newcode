...
class MnistModel:
    ...
    def __init__(self):
        # mnist测试集
        self.mnist = input_data.read_data_sets(r'C:\Myprogram\mnistdata', one_hot=True)
        # 图片大小
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            for epoch in range(self.epoch_size):
                ...
                if (epoch+1)%10==0:
                    ...
                    samples = sess.run(gen_outputs, feed_dict={fake_imgs: sample_noise})
                    with open(r'C:\Myprogram\mnistdata' + '\\' + str(epoch) + 'samplesepoch.pkl', 'wb') as f:
